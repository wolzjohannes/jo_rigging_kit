...
class Vhagar_face_rig(facialSystem.Facial_system):
    ...
    def __init__(self):
        ...
        model_path = "X:/redgun_reg-6344/_library/assets/creature/crt_vhagar/mdl/_publish/reg_crt_vhagar_mdl_v152_thz.mb"
        super(Vhagar_face_rig,self).__init__(character_name = self.name ,
                                                ...
                                                scale = 30,
                                               pre_build = self.vhagar_face_pre_build,
                                               upgrade = self.vhagar_face_upgrade,
                                               post_build = self.vhagar_face_post_build)

    def vhagar_face_pre_build(self):
    ...
    def vhagar_face_upgrade(self):
        self.eye_orbicularis_ctl()


    def vhagar_face_post_build(self):
