...
class SkinClusterOperator(DeformerOperator):
    ...
    """
    EXPORT_FOLDER_NAME: str         = constants.PXO_FILEPATH_BSHP

    ALLOWED_OBJECT_TYPES: list      = ["mesh", "nurbsSurface", "nurbsCurve"]
    DEFORMER_TYPE_NAME: str         = "blendShape"
    DEFORMER_SUFFIX_NAME: str       = "BLS"

    DEFORMER_SETTINGS: dict         = {"envelope"               : ["as_float", None, None],
                                       "nodeState"              : ["as_int", None, None],
                                       "origin": ["as_int", None, None],
                                       "supportNegativeWeights": ["as_bool", None, None],
    ...
    def __init__(self, input_dag_node: str) -> None:
        ...
        self.FILE_NAMES["deformer_data"]                = "bls_node_data"
